...
Console.WriteLine(empresa1 == empresa2);

EmpresaTransporte2 empresa3 = new(2, "empresa3", "transporte");
EmpresaTransporte2 empresa4 = new(2, "empresa3", "transporte");

Console.WriteLine(empresa3 == empresa4);
...
public record EmpresaTransporte2( int Id, string name, string tipoServicios);
